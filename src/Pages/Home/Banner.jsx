      ...
      <section>
        <div className="w-[95%] my-7 bg-orange-50 rounded-lg px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
          <div className="flex flex-wrap items-center mx-auto max-w-7xl">
            ...
            <div className="flex flex-col items-center md:items-center lg:items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
              ...
              <p className="mb-8 text-base leading-relaxed text-left text-gray-900">
                Where Every Workout Tells a Story of Progress. Your Journey to a
                Healthier, Stronger You Starts Here. Join Our Community of
                Fitness Enthusiasts
              </p>
